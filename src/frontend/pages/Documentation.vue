<template>
			...
			<div class="documents">
				<div class="hill-box" id="events">
					...
					<div class="hill-box-body">
						<DocumentationEndpoint type="GET" endpoint="/api/activity/" description="Get a random event" query="http://bored.api.lewagon.com/api/activity/" :id="'endpoints-random'" response='{
	...
	"key": "3943506"
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?key=:key" description="Find an activity by its key" query="http://bored.api.lewagon.com/api/activity?key=5881028" :id="'endpoints-key'" response='{
	...
	"key": "5881028"
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?type=:type" description="Find a random activity with a given type" query="http://bored.api.lewagon.com/api/activity?type=recreational" :id="'endpoints-type'" response='{
	...
	"key": "5808228"
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?participants=:participants" description="Find a random activity with a given number of participants" query="http://bored.api.lewagon.com/api/activity?participants=1" :id="'endpoints-participants'" response='{
	...
	"key": "3136036"
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?price=:price" description="Find an activity with a specified price" query="http://bored.api.lewagon.com/api/activity?price=0.0" :id="'endpoints-price'" response='{
	...
	"price": 0.0,
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?minprice=:minprice&maxprice=:maxprice" description="Find an event with a specified price in an inclusively constrained range" query="http://bored.api.lewagon.com/api/activity?minprice=0&maxprice=0.1" :id="'endpoints-price-range'" response='{
	...
	"price":0.05
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?accessibility=:accessibility" description="Find a price in an inclusively constrained range" query="http://bored.api.lewagon.com/api/activity?accessibility=1" :id="'endpoints-accessibility'" response='{
	...
	"price": 0.15,
						...
						<DocumentationEndpoint type="GET" endpoint="/api/activity?minaccessibility=:minaccessibility&maxaccessibility=:maxaccessibility" description="Find an event with a specified accessibility in an inclusively constrained range" query="http://bored.api.lewagon.com/api/activity?minaccessibility=0&maxaccessibility=0.1" :id="'endpoints-accessibility-range'" response='{
